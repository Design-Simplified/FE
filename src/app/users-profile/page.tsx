...
export default function MyProfilePages() {
  ...
  return (
    <>
      ...
      <main className="w-full relative background-gray xl:pt-12 lg:pt-10 md:pt-8 sm:pt-6  pt-4 flex flex-col gap-2 xl:gap-6 lg:gap-5 md:gap-4 sm:gap-3">
        <div className="w-full flex flex-row gap-10 justify-between items-center px-3 xl:px-8 lg:px-7 md:px-6 sm:px-5 py-4 xl:py-7 lg:py-6 md:py-5">
