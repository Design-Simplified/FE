...
export default function SecondSection() {
  return (
    <div className="bg-white w-full py-16 pt-64 sm:pt-0 sm:mt-0 mt-32 pb-20 px-5 flex flex-col sm:px-12 lg:px-16 sm:py-36 sm:flex-row gap-5 sm:gap-0 items-center justify-center">
